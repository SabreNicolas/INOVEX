...
export class ListConsignesComponent implements OnInit {
  ...
  @ViewChild('myCreateConsigneDialog') createConsigneDialog = {} as TemplateRef<any>;
  ...
  constructor(private rondierService : rondierService, private datePipe : DatePipe, private formbuilder: FormBuilder, private dialog : MatDialog,public cahierQuartService : cahierQuartService, private popupService : PopupService) {
    this.listConsignes = [];
    this.idConsigne = 0;
    this.stringDateFin = "";
