...
export class PopupService {
     ...
     */
    alertSuccessForm(title: string = "La requête a bien été effectué", timer: number = 5000, color: string = 'green') {
        // Création
     ...
     * @param title La réponse qui sera affiché
     */
    public alertErrorForm(title: string = "Veuillez bien remplir le formulaire !", timer: number = 5000, color: string = "red") {
        // Création
        const notifError = Swal.mixin({
        toast:true,
        position: 'bottom',
