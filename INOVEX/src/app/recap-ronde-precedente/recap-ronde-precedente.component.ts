...
export class RecapRondePrecedenteComponent {
  ...
  async createPDF(){
    ...
    const tableBody : any[] = [
        [{text : 'Rondier',  margin: [0,0,0,0], fontSize: 10,style: 'tableCell'},
        {text : 'Poste',  margin: [0,0,0,0], fontSize: 10,style: 'tableCell'},]
    ]

    for(let rondier of this.listRondier){
      tableBody.push([
        {text : rondier.Poste, fontSize: 10,style: 'tableHeader',margin: [0,0,0,0]},
        {text : rondier.Nom + ' ' + rondier.Prenom, fontSize: 10,style: 'tableHeader',margin: [0,0,0,0]},
      ])
    }

    const tableConsgines : any[] = [
      [{text : 'Consignes :',  margin: [0,0,0,0], fontSize: 10,style: 'tableCell'}]
    ]

    for(let consigne of this.listConsigne){
      tableConsgines.push([
        {text : consigne.titre + ' - ' + consigne.commentaire, fontSize: 10,style: 'tableHeader',margin: [0,0,0,0]},
      ])
    }

    const tableAnomalies : any[] = [
      [{text : 'Anomalies :',  margin: [0,0,0,0], fontSize: 10,style: 'tableCell'},{text:''}]
    ]
    ...
    for(let anomalie of this.listAnomalies){
      ...
      tableAnomalies.push([
        {text : anomalie.commentaire, fontSize: 10,style: 'tableHeader',margin: [0,0,0,0]},
        {image : base64, width:300}
      ])
    }

    const tableActions : any[] = [
      [{text : 'Actions :',  margin: [0,0,0,0], fontSize: 10,style: 'tableCell'}]
    ]
    ...
    for(let action of this.listAction){
      ...
      tableActions.push([
        {text : action.nom, fontSize: 10,style: 'tableHeader',margin: [0,0,0,0],fillColor: color},
      ])
    }

    const tableEvents : any[] = [
      [{text : 'Evènements :',  margin: [0,0,0,0], fontSize: 10,style: 'tableCell'}]
    ]
    ...
    for(let event of this.listEvenement){
      ...
      tableEvents.push([
        {text : text, fontSize: 10,style: 'tableHeader',margin: [0,0,0,0],fillColor: color,},
      ])
    }

    const tableRonde : any[] = [
      [{text : 'Zones :',  margin: [0,0,0,0], fontSize: 10,style: 'tableCell'}]
    ]
    ...
    for(let zone of this.listZone){
      ...
      tableRonde.push([
        {text : zone.zone, fontSize: 10,style: 'tableHeader',margin: [0,0,0,0],fillColor: color},
      ])
    }    
    
    const tableDateQuart = [
      [{text:'Date : ' + this.formatDateTime(this.dateDebString),fontSize: 10}],
    ...
    const tableSignature = [
      ...
      [
        ...
        {
          stack:[
            {text:'Entrant : ' + this.user,fontSize: 10, margin:[0,0,0,0]},
            {
              image :'data:image/png;base64,',
              width:125,
              height:100
