...
export class RecapRondePrecedenteComponent {
  ...
  createPDF(){
    ...
    const tableAnomalies : any[] = [
      [{text : 'Anomalies :',  margin: [0,0,0,0], fontSize: 10,style: 'tableCell'}]
    ]

    // for(let consigne of this.lis){
    //   console.log(consigne)
    //   tableConsgines.push([
    //     {text : consigne.titre + ' - ' + consigne.commentaire, fontSize: 10,style: 'tableHeader',margin: [0,0,0,0]},
    //   ])
    ...
    const tableSignature = [
      ...
      [
        {
          stack:[
            {text:'Sortant :',fontSize: 10, margin:[0,0,0,0]},
            {
        ...
        {
          stack:[
            {text:'Entrant :',fontSize: 10, margin:[0,0,0,0]},
            {
              image :'data:image/png;base64,',
              width:125,
              height:100
