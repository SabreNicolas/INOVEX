...
export class ListActusComponent implements OnInit {
          ...
          this.cahierQuartService
            ...
            .subscribe((response) => {
              if (response == "Modif de l'actu OK !") {
                this.cahierQuartService
                  .historiqueActuUpdate(this.idActu)
                  .subscribe((response) => {
          ...
          this.cahierQuartService
            ...
            .subscribe((response) => {
              ...
              if (response != undefined) {
                ...
                this.cahierQuartService
                  .historiqueActuCreate(this.idActu)
                  .subscribe((response) => {
                    this.popupService.alertSuccessForm(
  ...
  deleteActu(id: number) {
    Swal.fire({
      title: "Etes vous sûr de vouloir supprimer cette actu ?",
      icon: "warning",
      showCancelButton: true,
      confirmButtonColor: "#3085d6",
      cancelButtonColor: "#d33",
      ...
      if (result.isConfirmed) {
        this.cahierQuartService.deleteActu(id).subscribe((response) => {
          if (response == "Suppression de l'actu OK") {
            ...
            this.popupService.alertErrorForm(
              "Erreur lors de la suppression de l'actu....",
            );
          }
        });
        this.ngOnInit();
