...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "reactifs",
        canActivate: [AuthGuard],
        component: ListReactifsComponent,
      },
      {
        path: "listCompteurs",
        canActivate: [AuthGuard],
      ...
      },
      {
        path: "listForm",
        canActivate: [AuthGuard],
        component: ListFormulairesComponent,
      },
      {
        path: "saisieForm",
        canActivate: [AuthGuard],
    ...
    children: [
      {
        path: "",
        canActivate: [AuthGuard],
        component: AcceuilCahierQuartComponent,
      },
      {
        path: "listEquipe",
        canActivate: [AuthGuard],
      ...
      },
      {
        path: "consignes",
        canActivate: [AuthGuard],
        component: ListConsignesComponent,
      },
      ...
      {
        path: "newEnregistrementEquipe",
        canActivate: [AuthGuard],
        component: EnregistrementEquipeComponent,
      },
      {
        path: "enregistrementEquipe",
        canActivate: [AuthGuard],
        component: ListEnregistrementEquipeComponent,
      },
      {
        path: "recherche",
        canActivate: [AuthGuard],
      ...
      },
      {
        path: "liensExternes",
        canActivate: [AuthGuard],
        component: ListLiensExternesComponent,
      },
      {
        path: "newLienExterne",
        canActivate: [AuthGuard],
        component: LiensExternesComponent,
      },
      {
        path: "recapRondePrecedente",
        canActivate: [AuthGuard],
        component: RecapRondePrecedenteComponent,
      },
      {
        path: "recapRondeListe",
        canActivate: [AuthGuard],
        component: RecapRondeListeComponent,
      },
      { path: "arrets", canActivate: [AuthGuard], component: ArretsComponent },
      {
        path: "listArrets",
...

  {
    ...
    // component : MaintenanceComponent,
    children: [
      { path: "", canActivate: [AuthGuard], component: ListConsignesComponent },
      ...
      },
      {
        path: "newSortant",
        canActivate: [AuthGuard],
        component: SortantsComponent,
      },
      {
        path: "newAnalyse",
        canActivate: [AuthGuard],
        component: NewAnalyseComponent,
      },
      ...
      },
      {
        path: "tags",
        canActivate: [AuthGuard],
        component: TagAffectationComponent,
      },
      ...
      },
      {
        path: "gestionBadge",
        canActivate: [AuthGuard],
        component: GestionBadgeComponent,
      },
      {
        path: "newZone",
        canActivate: [AuthGuard],
        component: ZoneControleComponent,
      },
      {
        path: "zones",
        canActivate: [AuthGuard],
      ...
      },
      {
        path: "newElement",
        canActivate: [AuthGuard],
        component: ElementControleComponent,
      },
      {
        path: "elements",
        canActivate: [AuthGuard],
      ...
      },
      {
        path: "groupement",
        canActivate: [AuthGuard],
        component: ListGroupementsComponent,
      },
      {
        path: "permisFeu",
        canActivate: [AuthGuard],
        component: PermisFeuComponent,
      },
      {
        path: "reporting",
        canActivate: [AuthGuard],
      ...
      },
      {
        path: "modesOP",
        canActivate: [AuthGuard],
        component: ListModeOperatoireComponent,
      },
      {
        path: "newConsigne",
        canActivate: [AuthGuard],
      ...
      },
      {
        path: "finMois",
        canActivate: [AuthGuard],
        component: RondierFinMoisComponent,
      },
      {
        path: "correspondanceSortants",
        canActivate: [AuthGuard],
        component: CorrespondanceSortantsComponent,
      },
      {
        path: "CorrespondanceReactifs",
        canActivate: [AuthGuard],
        component: CorrespondanceReactifsComponent,
      },
      {
        path: "newForm",
        canActivate: [AuthGuard],
